...
mongo week6 --eval "load('../chapter_6_scalability/week6__hw6.1_m102_52b491d5e2d4237593ca1d3a.js'); homework.init(); db.getSiblingDB('admin').shutdownServer();"
...
@REM Adds the shard and prints the solution.
